    ...
    <div className="resume-container">
      <div className="resume-content">
        ...
        <ul>
          ...
          <li className="resumeListItem">Full-Stack Coding Bootcamp Certification Dec 2023</li>
          ...
          <li className="resumeListItem">BS in Environmental Science Jan 2021</li>

          <li className="resumeListItem resumeTitle">Experience</li>
          <li className="resumeListItem">- 6-month Intensive Coding Bootcamp</li>
          ...
          <li className="resumeListItem resumeInfo">- Creating responsive web APIs</li>
